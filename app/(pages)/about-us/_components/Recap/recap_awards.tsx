  ...
  return (
    <div className="flex w-full flex-col items-center justify-center">
      ...
      <a
        ...
        className="mt-4 flex max-h-[50px] items-center justify-center overflow-hidden text-ellipsis whitespace-nowrap rounded-full bg-[#FFC53D] px-14 py-4 font-semibold text-[#58452B] transition-opacity hover:opacity-90"
      >
