    ...
    <div className="flex flex-col items-start gap-[22px] break-625:items-end break-625:gap-[31px]">
      ...
      <div className="flex flex-col items-start gap-[12px] break-625:flex-col break-625:items-end break-625:gap-[28px] sm:flex-col">
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <button className="grid w-fit place-items-center justify-center rounded-full border-none bg-[--background-dark] pb-[8px] pl-[24px] pr-[24px] pt-[8px] text-[16px] font-bold text-[--text-light] break-625:pb-[10px] break-625:pl-[30px] break-625:pr-[30px] break-625:pt-[10px] break-625:text-[20px]">
