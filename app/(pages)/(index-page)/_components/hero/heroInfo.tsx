  ...
  return (
    <div className="flex flex-col gap-[31px] items-end">
      <div className="flex flex-col items-end text-right">
        ...
        <h1 className="text-white font-metropolis text-[88px] font-bold tracking-[3.52px]">
          social good
        </h1>
      ...
      <div className="flex items-center gap-2 text-right">
        <span className="text-white font-metropolis text-[24px] font-normal tracking-[0.48px]">
          Apply to be a{' '}
        </span>
        <span className="text-white font-metropolis text-[24px] font-bold tracking-[0.48px]">
          Judge, Mentor,
        </span>
        <span className="text-white font-metropolis text-[24px] font-normal tracking-[0.48px]">
          or{' '}
